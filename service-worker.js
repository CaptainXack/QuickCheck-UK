const CACHE_NAME = 'quickcheck-uk-v11';
...
const APP_SHELL = [
  ...
  BASE + 'assets/pwa.js?v=6',
  BASE + 'assets/home-routes.js?v=2',
  BASE + 'assets/home-dashboard.css?v=1',
  BASE + 'assets/home-dashboard.js?v=2',
  BASE + 'assets/money-shelves.js?v=2',
