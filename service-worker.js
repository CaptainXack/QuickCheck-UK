const CACHE_NAME = 'quickcheck-uk-v16';
...
const APP_SHELL = [
  ...
  BASE + 'assets/bill-calendar.css?v=1',
  BASE + 'assets/bill-calendar.js?v=1',
  BASE + 'assets/data-manager.css?v=1',
  BASE + 'assets/data-manager.js?v=1',
